...
final kTranslationsMap = <Map<String, Map<String, String>>>[
  ...
  // registerAccount
  {
    ...
    'oitrrwgg': {
      'en': 'Cree su cuenta a continuación.',
  ...
  // completeProfile
  {
    ...
    'r6npjsue': {
      'en': 'Sube una foto para que podamos identificarte fácilmente.',
  ...
  // forgotPassword
  {
    ...
    'xaiad71o': {
      'en':
          'Introduzca el correo electrónico asociado a su cuenta y le enviaremos un código de verificación.',
  ...
  // homePage
  {
    ...
    'ld6j46ly': {
      'en': 'Ultima actualización: Septiembre 16, 2023, 06:52 PST',
      'ar': '',
      'de': '',
      'es': '',
    },
    ...
    '8cbuhvv3': {
      'en': 'Total pcs faltantes',
      'ar': '',
      'de': '',
      'es': '',
    },
    'n7v3mep9': {
      'en': 'Total pcs producidas',
      'ar': '',
      'de': '',
      'es': '',
    },
  ...
  // budgetDetails
  {
    ...
    '0vcoer78': {
      'en':
          'Tshirt white                                                                                        5214 pcs\nTshirt polo                                                                                          4755 pcs\nHoddie brown                                                                                    2542 pcs',
      'ar': '',
      'de': '',
      'es': '',
    },
    ...
    '6aj85xde': {
      'en': 'Inicio de proceso de producción código:\n54785, 57557 y 36585',
      'ar': '',
      'de': '',
      'es': '',
    },
  ...
  // changePassword
  {
    ...
    '2b97u8y5': {
      'en':
          'Introduzca el correo electrónico asociado a su cuenta y le enviaremos un enlace para restablecer su contraseña.',
      'ar':
  ...
  // notificationsSettings
  {
    ...
    'r72zvrv5': {
      'en': 'Elija a continuación las notificaciones que desea recibir.',
    ...
    '3y3yhxbk': {
      'en':
          'Recibe notificaciones Push de nuestra aplicación de forma semiregular.',
    ...
    '9lvh5nst': {
      'en':
          'Reciba notificaciones por correo electrónico de nuestro equipo sobre sus pedidos.',
      'ar':
    ...
    '3k8cuv0d': {
      'en':
          'Permítanos seguir su ubicación, esto ayuda a controlar mejor los pedidos.',
      'ar':
  ...
  // privacyPolicy
  {
    ...
    'nbiyrnzl': {
      'en':
          '1. Información que Recopilamos\n1.1. Información de Registro: Cuando te registras en la Aplicación, recopilamos información personal como tu nombre, dirección de correo electrónico, número de teléfono y contraseña.\n1.2. Información de Uso: Recopilamos información sobre cómo interactúas con la Aplicación, incluyendo las acciones que realizas, las consultas de búsqueda y la frecuencia y duración de tu uso.\n1.3. Información del Dispositivo: Recopilamos información sobre tu dispositivo móvil, incluyendo el modelo del dispositivo, sistema operativo, identificadores únicos del dispositivo y datos de registro móvil.\n2. Uso de la Información\n2.1. Propósitos del Uso: Utilizamos la información recopilada para proporcionarte acceso y mejorar la funcionalidad de la Aplicación, comunicarnos contigo, responder a tus solicitudes y proporcionarte información relevante.\n2.2. Comunicaciones: Podemos enviarte correos electrónicos o notificaciones relacionadas con la Aplicación, como actualizaciones o cambios en los servicios.\n3. Compartir Información\n3.1. Terceros de Confianza: Podemos compartir tu información con terceros de confianza para fines relacionados con la Aplicación, como proveedores de servicios de alojamiento de datos y servicios de análisis.\n3.2. Requisitos Legales: Podemos divulgar tu información si estamos obligados a hacerlo por ley o en respuesta a una orden judicial válida.\n4. Seguridad de la Información\n4.1. Medidas de Seguridad: Implementamos medidas de seguridad razonables para proteger tu información contra accesos no autorizados, divulgación, alteración o destrucción.\n5. Tus Derechos\n5.1. Acceso y Corrección: Tienes derecho a acceder y corregir tu información personal en la Aplicación.\n5.2. Eliminación de Datos: Puedes solicitar la eliminación de tu cuenta y tus datos personales en cualquier momento.\n6. Cambios en la Política de Privacidad\n6.1. Actualizaciones: Esta Política de Privacidad puede ser actualizada periódicamente para reflejar cambios en nuestras prácticas de privacidad. La fecha de entrada en vigor será actualizada en consecuencia.\n7. Contacto\nSi tienes alguna pregunta o inquietud sobre esta Política de Privacidad o tus datos personales, por favor, contáctanos en [correo electrónico de contacto].\n\nFecha de entrada en vigor: 7 de septiembre de 2023\n\nEsta Política de Privacidad forma parte integral de los Términos y Condiciones de Uso de TraceTex.\n',
      'ar':
  ...
  // budgetDetailsCopy
  {
    ...
    'zxeum6zv': {
      'en':
          'Empresa xyz\nCiudad de Guatemala\n3-20 zona 12, Ciudad de Guatemala',
      'ar': '',
      'de': '',
      'es': '',
    },
